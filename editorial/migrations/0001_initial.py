    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_details', models.OneToOneField(limit_choices_to={'role': 'Author'}, on_delete=django.db.models.deletion.CASCADE, related_name='article_author_details', to=settings.AUTH_USER_MODEL)),
                ('editor_details', models.ForeignKey(blank=True, limit_choices_to={'role': 'Editor'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='article_editor_details', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commented_by', models.ForeignKey(blank=True, limit_choices_to={'role': 'Editor'}, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='editor_article_feed', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
