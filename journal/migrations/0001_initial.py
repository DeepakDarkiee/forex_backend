# Generated by Django 3.2.15 on 2022-10-26 11:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('journal_author', models.ForeignKey(blank=True, limit_choices_to={'role': 'Author'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subscriber_author_journal', to=settings.AUTH_USER_MODEL)),
                ...
                ('journal_reviewer', models.ForeignKey(blank=True, limit_choices_to={'role': 'Reviewer'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subscriber_reviewer_journal', to=settings.AUTH_USER_MODEL)),
                ('journal_subscriber', models.ForeignKey(blank=True, limit_choices_to={'role': 'Subscriber'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subscriber_journal', to=settings.AUTH_USER_MODEL)),
